                    ...
                    <div className="row mb-5 mb-xl-8 g-5 g-xl-8">
                            ...
                            <div className="card card-stretch">
                                ...
                                <a href="../../demo9/dist/account/statements.html"
                                   className="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <span className="fs-4 fw-bold">Statements</span>
                                </a>
                            ...
                            <div className="card card-stretch">
                                ...
                                <a href="../../demo9/dist/account/referrals.html"
                                   className="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <span className="fs-4 fw-bold">Best Referrals</span>
                                </a>
                        ...
                        <div className="col-6">
                            ...
                            <div className="card card-stretch">
                                ...
                                <a href="../../demo9/dist/apps/customers/view.html"
                                   className="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <span className="fs-4 fw-bold">Hot Picks</span>
                                </a>
                        ...
                        <div className="col-6">
                            ...
                            <div className="card card-stretch">
                                ...
                                <a href="../../demo9/dist/apps/projects/project.html"
                                   className="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <span className="fs-4 fw-bold">Latest Trands</span>
                                </a>
                        ...
                        <div className="col-6">
                            ...
                            <div className="card card-stretch">
                                ...
                                <a href="../../demo9/dist/apps/projects/users.html"
                                   className="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <span className="fs-4 fw-bold">New Arrivals</span>
                                </a>
